...
const {getUsers,newUser, getUserById, updateUser, deleteUser, confirmEmail, loggedInUser,getUserByBatch,getUserByCity,getUserByInterest,getUserByWork_Status,updateUserPicture} = require("../Controllers/users");
